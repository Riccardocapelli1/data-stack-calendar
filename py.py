...
df = df[~df['Tweet'].str.contains('Of courses|of courses|event log|Event log|CDC event|event systems|Steven|steven|Prevent|prevent|Event streaming|event streaming|SSL certificate|GhEvent|EventTimer')]
...
df_conference = df_conference[~df_conference['Tweet'].str.contains('event log|Event log|CDC event|event systems|Steven|steven|Prevent|prevent|Event streaming|event streaming|SSL certificate|GhEvent|EventTimer')]
