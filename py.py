...
df_ = df[df['Tweet'].str.contains('Event|event|Conference|conference|Podcast|podcast|Badge|badge|Certific|certific|Webinar|webinar|free resources|free courses|free learning')]
...
html_content += "    <header class='header-area header-sticky'>\n"
html_content += "        <div class='container'>\n"
html_content += "            <div class='row'>\n"
html_content += "                <div class='col-12'>\n"
html_content += "                    <nav class='main-nav'>\n"
html_content += "                        <ul class='nav'>\n"
